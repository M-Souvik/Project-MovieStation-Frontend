  ...
  return (
    <div className='p-1 w-full'>
              <Card className={'h-[40rem] border-none relative w-full py-0 rounded overflow-hidden'}>
                <img src={movie.banner_poster} alt={movie.title} className='object-cover w-full h-full sm:h-auto object-top'/>
                ...
                <div className='flex flex-col items-center relative bottom-10 gap-3'>
                  <h1 className='font-semibold text-3xl text-center'>{movie.title}</h1>
                  <p className='text-sm text-center hidden sm:block font-thin max-w-[90%]'>{movie.description}</p>
